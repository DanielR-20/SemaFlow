// ============================================================================
// SCRIPT DE INSERCIÓN DE DATOS DE EJEMPLO (DML / SEEDING): SEMAFLOW
// Inserta más de 100 documentos realistas en total (40 users + 50 traffic_reports + 40 routes = 130 docs)
// ============================================================================

db = db.getSiblingDB("SEMAFLOW");

print("==========================================================");
print("Limpiando datos previos en las colecciones...");
print("==========================================================");
db.users.deleteMany({});
...
print("==========================================================");
print("Generando e insertando 40 usuarios en 'users'...");
print("==========================================================");
...
for (let i = 0; i < 40; i++) {
  ...
  usuarios.push({
    ...
    is_active: i !== 13 && i !== 27, // 38 activos, 2 inactivos
...
print(` -> ${db.users.countDocuments()} usuarios insertados exitosamente.`);

print("==========================================================");
print("Generando e insertando 50 reportes en 'traffic_reports'...");
print("==========================================================");
...
for (let i = 0; i < 50; i++) {
  ...
  const sevIdx = i % nivelesSeveridad.length;
  const estIdx = i % estadosReporte.length;
  const userIdx = i % 40;
  ...
  reportes.push({
    ...
    votes: [
      ...
      },
      {
        ...
        is_upvote: i % 5 !== 0, // En general votos positivos
...
print(` -> ${db.traffic_reports.countDocuments()} reportes de tráfico insertados exitosamente.`);

print("==========================================================");
print("Generando e insertando 40 consultas en 'routes'...");
print("==========================================================");
...
print(` -> ${db.routes.countDocuments()} consultas de rutas insertadas exitosamente.`);

const totalDocs = db.users.countDocuments() + db.traffic_reports.countDocuments() + db.routes.countDocuments();
print("==========================================================");
print(`¡SEEDING COMPLETADO! Total de documentos insertados: ${totalDocs}`);
print("==========================================================\n");
